...
void loop() {
  ...
  //TO-DO:   
  if (distance < 10 && distance > 5 ) {//Όταν βρίσκει ένα κοντινό εμπόδιο,
    folkracer.rotate(-90);//κάντε το αυτοκινητάκι να στρίβει 90 μοίρες προς τα αριστερά
    folkracer.setSpeed(0.5);//και να συνεχίζει την πορεία του
  }  
}
